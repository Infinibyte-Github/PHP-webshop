...
INSERT INTO products (productName, description, price, stock, active, image) VALUES ('Arduino Pro Mini', 'The Arduino Pro Mini is a microcontroller board based on the ATmega328. It has 14 digital input/output pins (of which 6 can be used as PWM outputs), 6 analog inputs, an on-board resonator, a reset button, and holes for mounting pin headers. A six pin header can be connected to an FTDI cable or Sparkfun breakout board to provide USB power and communication to the board.', 18.00, 10, true, 'https://docs.arduino.cc/static/6ef0d448db73013667ac934fd00f5914/a207c/e000025_featured.jpg');
-- a few raspberry pi's
INSERT INTO products (productName, description, price, stock, active, image) VALUES ('Raspberry Pi 3', 'The Raspberry Pi 3 is the third generation Raspberry Pi. It replaced the Raspberry Pi 2 Model B in February 2016. Compared to the Raspberry Pi 2 it has: A 1.2GHz 64-bit quad-core ARMv8 CPU. 802.11n Wireless LAN. Bluetooth 4.1. Bluetooth Low Energy (BLE)', 35.00, 10, true, 'https://images.prismic.io/rpf-products/877fb653-7b43-4931-9cee-977a22571f65_3b+Angle+2+refresh.jpg');
INSERT INTO products (productName, description, price, stock, active, image) VALUES ('Raspberry Pi Zero', 'The Raspberry Pi Zero is half the size of a Model A+, with twice the utility. A tiny Raspberry Pi thats affordable enough for any project!', 5.00, 10, true, 'https://images.prismic.io/rpf-products/656a14be-ba7e-476d-94ff-3dba02c4050e_Pi+ZERO+Angle+1.jpg');
INSERT INTO products (productName, description, price, stock, active, image) VALUES ('Raspberry Pi 2', 'The Raspberry Pi 2 Model B is the second-generation Raspberry Pi. It replaced the original Raspberry Pi 1 Model B+ in February 2015.', 25.00, 10, true, 'https://images.prismic.io/rpf-products/27896b7c-0a71-4431-9cef-0c93c256d464_2B+ANGLE+1+REFRESH.jpg');